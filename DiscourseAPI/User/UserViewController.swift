...
class UserViewController: UIViewController {
    ...
    var prueba: UsersViewController
    ...
    init(viewModel: UserViewModel, prueba: UsersViewController) {
    ...
    fileprivate func showSuccessUpdatingUserName() {
        showAlert("The user name has been successfully updated! Restart the app to see the changes", "Success!", "OK")
